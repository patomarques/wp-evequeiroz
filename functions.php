...
function create_post_type() {
    ...
    register_post_type( 'handpoke-tatto',
        array(
            'labels' => array(
    ...
    register_post_type( 'lambe-lambe-stickers',
        array(
            'labels' => array(
    ...
    register_post_type( 'graffiti',
        array(
            'labels' => array(
                'name' => __( 'Graffiti' ),
                'singular_name' => __( 'graffiti' )
            ),
            'public' => true,
            'has_archive' => true,
            'supports' => array(
